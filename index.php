        ...
        <div class="card bg-card-col mb-4 mt-5">
          ...
          <form action="#" method="post">
            <div class="card-body row">
              ...
              ?>
                <input class="form-control md-3" type="text" value="<?= $_POST['md5_str']?>" name="md5_str" placeholder="Enter Password">
              <?php
              } else{ ?>
                <input class="form-control md-3" type="text" name="md5_str" placeholder="Enter Password">
              <?php
              }
              ?>
